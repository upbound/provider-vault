...
// SetupGated adds a controller that reconciles SecretBackendRole managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1alpha1.SecretBackendRole_GroupVersionKind.String())
		}
	}, v1alpha1.SecretBackendRole_GroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	// if they're enabled.
	if o.StartWebhooks {
		if err := ctrl.NewWebhookManagedBy(mgr, &v1alpha1.SecretBackendRole{}).
			Complete(); err != nil {
