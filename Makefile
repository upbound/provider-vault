...
GO_STATIC_PACKAGES = $(GO_PROJECT)/v2/cmd/provider $(GO_PROJECT)/v2/cmd/generator
GO_LDFLAGS += -X $(GO_PROJECT)/v2/internal/version.Version=$(VERSION)
GO_SUBDIRS += v2/cmd v2/internal v2/apis
