...
type PinnedVersionInitParameters struct {
	...
	// Name of the plugin.
	// Name of the plugin.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v4/apis/cluster/plugin/v1alpha1.Plugin
	...
	// +kubebuilder:validation:Optional
	TypeRef *v2.Reference `json:"typeRef,omitempty" tf:"-"`

	// Selector for a Plugin in plugin to populate type.
	// +kubebuilder:validation:Optional
	TypeSelector *v2.Selector `json:"typeSelector,omitempty" tf:"-"`
