...
func (in *AuthBackendRoleInitParameters) DeepCopyInto(out *AuthBackendRoleInitParameters) {
	*out = *in
	...
	if in.OcspMaxRetries != nil {
		in, out := &in.OcspMaxRetries, &out.OcspMaxRetries
		*out = new(float64)
		**out = **in
	}
	...
	if in.OcspThisUpdateMaxAge != nil {
		in, out := &in.OcspThisUpdateMaxAge, &out.OcspThisUpdateMaxAge
		*out = new(float64)
		**out = **in
	}
