...
func (in *AuthBackendClientInitParameters) DeepCopyInto(out *AuthBackendClientInitParameters) {
	*out = *in
	...
	if in.AllowedStsHeaderValues != nil {
		in, out := &in.AllowedStsHeaderValues, &out.AllowedStsHeaderValues
	...
	if in.SecretKeyWoSecretRef != nil {
		in, out := &in.SecretKeyWoSecretRef, &out.SecretKeyWoSecretRef
		*out = new(v1.SecretKeySelector)
		**out = **in
	}
	if in.SecretKeyWoVersion != nil {
		in, out := &in.SecretKeyWoVersion, &out.SecretKeyWoVersion
		*out = new(float64)
		**out = **in
	}
...
func (in *SecretBackendRoleInitParameters) DeepCopyInto(out *SecretBackendRoleInitParameters) {
	*out = *in
	...
	if in.MfaSerialNumber != nil {
		in, out := &in.MfaSerialNumber, &out.MfaSerialNumber
		*out = new(string)
		**out = **in
	}
	if in.Name != nil {
