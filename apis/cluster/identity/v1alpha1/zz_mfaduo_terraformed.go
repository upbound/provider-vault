...
func (tr *MfaDuo) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"integration_key": "integrationKeySecretRef", "secret_key": "secretKeySecretRef"}
}
...
// GetInitParameters of this MfaDuo
func (tr *MfaDuo) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
