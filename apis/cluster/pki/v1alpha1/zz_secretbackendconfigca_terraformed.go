...
func (tr *SecretBackendConfigCA) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"pem_bundle": "pemBundleSecretRef"}
}
...
// GetInitParameters of this SecretBackendConfigCA
func (tr *SecretBackendConfigCA) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
