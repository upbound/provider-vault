...
func (in *CassandraInitParameters) DeepCopyInto(out *CassandraInitParameters) {
	*out = *in
	...
	if in.LocalDatacenter != nil {
		in, out := &in.LocalDatacenter, &out.LocalDatacenter
		*out = new(string)
		**out = **in
	}
	...
	if in.SocketKeepAlive != nil {
		in, out := &in.SocketKeepAlive, &out.SocketKeepAlive
		*out = new(string)
		**out = **in
	}
	if in.TLS != nil {
...
func (in *SecretBackendConnectionInitParameters) DeepCopyInto(out *SecretBackendConnectionInitParameters) {
	*out = *in
	...
	if in.SkipStaticRoleImportRotation != nil {
		in, out := &in.SkipStaticRoleImportRotation, &out.SkipStaticRoleImportRotation
		*out = new(bool)
		**out = **in
	}
	if in.Snowflake != nil {
