...
func (in *AuthBackendConfigInitParameters) DeepCopyInto(out *AuthBackendConfigInitParameters) {
	*out = *in
	...
	if in.MaxRetryDelay != nil {
		in, out := &in.MaxRetryDelay, &out.MaxRetryDelay
		*out = new(float64)
		**out = **in
	}
	if in.Namespace != nil {
...
func (in *SecretBackendInitParameters) DeepCopyInto(out *SecretBackendInitParameters) {
	*out = *in
	...
	if in.RootPasswordTTL != nil {
		in, out := &in.RootPasswordTTL, &out.RootPasswordTTL
		*out = new(float64)
		**out = **in
	}
	if in.RotationPeriod != nil {
...
func (in *SecretBackendRoleInitParameters) DeepCopyInto(out *SecretBackendRoleInitParameters) {
	*out = *in
	...
	if in.PersistApp != nil {
		in, out := &in.PersistApp, &out.PersistApp
		*out = new(bool)
		**out = **in
	}
	if in.Role != nil {
