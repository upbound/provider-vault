...
func (in *SecretBackendInitParameters) DeepCopyInto(out *SecretBackendInitParameters) {
	*out = *in
	...
	if in.ClientKeyWoSecretRef != nil {
		in, out := &in.ClientKeyWoSecretRef, &out.ClientKeyWoSecretRef
		*out = new(v1.SecretKeySelector)
		**out = **in
	}
	if in.ClientKeyWoVersion != nil {
		in, out := &in.ClientKeyWoVersion, &out.ClientKeyWoVersion
		*out = new(float64)
		**out = **in
	}
	...
	if in.TokenWoSecretRef != nil {
		in, out := &in.TokenWoSecretRef, &out.TokenWoSecretRef
		*out = new(v1.SecretKeySelector)
		**out = **in
	}
	if in.TokenWoVersion != nil {
		in, out := &in.TokenWoVersion, &out.TokenWoVersion
		*out = new(float64)
		**out = **in
	}
}
