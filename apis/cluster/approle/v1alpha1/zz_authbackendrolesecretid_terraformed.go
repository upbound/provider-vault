...
func (tr *AuthBackendRoleSecretID) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"secret_id": "secretIdSecretRef", "wrapping_token": "status.atProvider.wrappingToken"}
}
...
// GetInitParameters of this AuthBackendRoleSecretID
func (tr *AuthBackendRoleSecretID) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
