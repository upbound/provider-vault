...
func (in *AuthBackendLoginInitParameters) DeepCopyInto(out *AuthBackendLoginInitParameters) {
	*out = *in
	...
	if in.SecretIDWoSecretRef != nil {
		in, out := &in.SecretIDWoSecretRef, &out.SecretIDWoSecretRef
		*out = new(v1.SecretKeySelector)
		**out = **in
	}
	if in.SecretIDWoVersion != nil {
		in, out := &in.SecretIDWoVersion, &out.SecretIDWoVersion
		*out = new(float64)
		**out = **in
	}
}
