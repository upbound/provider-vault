...
func (tr *SecretV2) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"data": "status.atProvider.data", "data_json": "dataJsonSecretRef"}
}
...
// GetInitParameters of this SecretV2
func (tr *SecretV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
