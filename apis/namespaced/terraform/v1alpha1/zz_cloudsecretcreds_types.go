...
type CloudSecretCredsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v4/apis/namespaced/terraform/v1alpha1.CloudSecretBackend
	...
	// Name of the role.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v4/apis/namespaced/terraform/v1alpha1.CloudSecretRole
