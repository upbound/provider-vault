...
type SecretBackendInitParameters struct {
	...
	BindpassSecretRef v1.LocalSecretKeySelector `json:"bindpassSecretRef" tf:"-"`
	...
	// Client certificate to provide to the LDAP server, must be x509 PEM encoded.
	ClientTLSCertSecretRef *v1.LocalSecretKeySelector `json:"clientTlsCertSecretRef,omitempty" tf:"-"`

	// Client certificate key to provide to the LDAP server, must be x509 PEM encoded.
	// Client certificate key to provide to the LDAP server, must be x509 PEM encoded.
	ClientTLSKeySecretRef *v1.LocalSecretKeySelector `json:"clientTlsKeySecretRef,omitempty" tf:"-"`
