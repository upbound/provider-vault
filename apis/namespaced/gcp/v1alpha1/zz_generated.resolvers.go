...
// ResolveReferences of this SecretImpersonatedAccount.
func (mg *SecretImpersonatedAccount) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this SecretRoleset.
func (mg *SecretRoleset) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this SecretStaticAccount.
func (mg *SecretStaticAccount) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
