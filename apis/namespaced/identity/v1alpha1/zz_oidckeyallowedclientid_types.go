...
type OidcKeyAllowedClientIDInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v3/apis/namespaced/identity/v1alpha1.OidcRole
	...
	// Name of the key.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v3/apis/namespaced/identity/v1alpha1.OidcKey
