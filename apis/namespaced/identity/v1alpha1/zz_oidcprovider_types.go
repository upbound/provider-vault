...
type OidcProviderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/namespaced/identity/v1alpha1.OidcClient
	...
	// The scopes available for requesting on the provider.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/namespaced/identity/v1alpha1.OidcScope
