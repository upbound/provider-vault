...
type MfaLoginEnforcementInitParameters struct {
	...
	// Set of MFA method UUIDs.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v4/apis/namespaced/identity/v1alpha1.MfaDuo
	...
	MfaMethodIdsRefs []v1.NamespacedReference `json:"mfaMethodIdsRefs,omitempty" tf:"-"`

	// Selector for a list of MfaDuo in identity to populate mfaMethodIds.
	// +kubebuilder:validation:Optional
	MfaMethodIdsSelector *v1.NamespacedSelector `json:"mfaMethodIdsSelector,omitempty" tf:"-"`
