...
type GroupMemberEntityIdsInitParameters struct {
	...
	// ID of the group.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v4/apis/namespaced/identity/v1alpha1.Group
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/v4/apis/namespaced/identity/v1alpha1.Entity
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	// +listType=set
