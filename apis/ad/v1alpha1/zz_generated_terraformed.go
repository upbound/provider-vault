...
func (tr *SecretBackend) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"bindpass": "spec.forProvider.bindpassSecretRef", "client_tls_cert": "spec.forProvider.clientTlsCertSecretRef", "client_tls_key": "spec.forProvider.clientTlsKeySecretRef"}
}
