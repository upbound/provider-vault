...
type SecretBackend struct {
	...
	// +kubebuilder:validation:XValidation:rule="self.managementPolicy == 'ObserveOnly' || has(self.forProvider.binddn)",message="binddn is a required parameter"
	// +kubebuilder:validation:XValidation:rule="self.managementPolicy == 'ObserveOnly' || has(self.forProvider.bindpassSecretRef)",message="bindpassSecretRef is a required parameter"
