...
type SecretBackendRoleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/vault/v1beta1.Mount
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/database/v1beta1.SecretBackendConnection
