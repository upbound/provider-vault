...
type CloudSecretCredsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/terraform/v1beta1.CloudSecretBackend
	...
	// Name of the role.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/terraform/v1beta1.CloudSecretRole
