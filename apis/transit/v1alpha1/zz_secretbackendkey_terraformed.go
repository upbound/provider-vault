...
// GetInitParameters of this SecretBackendKey
func (tr *SecretBackendKey) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this SecretBackendKey using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecretBackendKey) LateInitialize(attrs []byte) (bool, error) {
	params := &SecretBackendKeyParameters{}
