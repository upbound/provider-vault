...
func (tr *Plugin) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"env[*]": "envSecretRef[*]"}
}

// GetObservation of this Plugin
func (tr *Plugin) GetObservation() (map[string]any, error) {
...
func (tr *Plugin) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this Plugin
...
func (tr *Plugin) GetParameters() (map[string]any, error) {
...
func (tr *Plugin) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Plugin
func (tr *Plugin) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Plugin
func (tr *Plugin) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Plugin using its observed tfState.
