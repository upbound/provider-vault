...
func (in *OidcKeyAllowedClientIDInitParameters) DeepCopyInto(out *OidcKeyAllowedClientIDInitParameters) {
	*out = *in
	...
	if in.AllowedClientIDRef != nil {
		in, out := &in.AllowedClientIDRef, &out.AllowedClientIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.AllowedClientIDSelector != nil {
		in, out := &in.AllowedClientIDSelector, &out.AllowedClientIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.KeyName != nil {
