...
type OidcKeyAllowedClientIDInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/identity/v1beta1.OidcRole
	...
	// Name of the key.
	// +crossplane:generate:reference:type=github.com/upbound/provider-vault/apis/identity/v1beta1.OidcKey
