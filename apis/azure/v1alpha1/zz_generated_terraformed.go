...
func (tr *AuthBackendConfig) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"client_id": "spec.forProvider.clientIdSecretRef", "client_secret": "spec.forProvider.clientSecretSecretRef", "tenant_id": "spec.forProvider.tenantIdSecretRef"}
}
...
func (tr *SecretBackend) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"client_id": "spec.forProvider.clientIdSecretRef", "client_secret": "spec.forProvider.clientSecretSecretRef", "subscription_id": "spec.forProvider.subscriptionIdSecretRef", "tenant_id": "spec.forProvider.tenantIdSecretRef"}
}
