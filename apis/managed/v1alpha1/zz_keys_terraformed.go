...
// GetInitParameters of this Keys
func (tr *Keys) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Keys using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Keys) LateInitialize(attrs []byte) (bool, error) {
	params := &KeysParameters{}
